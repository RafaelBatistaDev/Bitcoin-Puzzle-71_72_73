...
# Ethereum Puzzles - Parallel Execution
# Uso: SEARCH_MODE=sequential ./run_all_puzzles_ethereum.sh
#      SEARCH_MODE=random ./run_all_puzzles_ethereum.sh
...
echo "⏱️  Delay do Ethereum ajustado para 2.5s para execução paralela segura"

echo "🔍 Ethereum: P71 P72 P73 (${SEARCH_MODE})"
